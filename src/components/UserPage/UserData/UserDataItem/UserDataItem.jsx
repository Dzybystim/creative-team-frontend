...
const [birthdayField, setChangeBirthdayField] = useState(birthdate ? birthdate : "00.00.0000");
const [phoneField, setChangePhoneField] = useState(mobilePhone ? mobilePhone : "+38000000000");
...
const handleClick = (event) => {
    switch(event.currentTarget.name){
        ...
        case 'city':
          ...
          break;
          default: console.error('Ошибка в UserDataItem (handleVlick)')
      }
}
...
const handleChange = event => {
    switch(event.target.name){
      ...
      case 'city':
        ...
        default: console.error('Ошибка в UserDataItem (handleChange)')
    }
  }
...
<tr >
      ...
      <>
         <td><p className={css.text_user}>{name}</p></td>
         <td><button type="button" className={css.button_pencil} name="name" onClick={handleClick}>
        ...
        className={css.input}
        ></input></td>
        <td><button type="button" className={css.button_pencil} name="name" onClick={clickSubmit}>
    ...
    <tr>
      ...
      <>
       <td><p className={css.text_user}>{email}</p></td>
      <td><button type="button" className={css.button_pencil} name="email" onClick={handleClick}>
        <HiPencil className={css.pencil}/></button></td>   
      </>
         :
         <>
        ...
        className={css.input}
        ></input></td> 
        <td><button type="button" className={css.button_pencil} name="email" onClick={clickSubmit}>
            <BsCheck className={css.check}/></button></td>
        </>
      }
    ...
    <tr>
      ...
      <td><button type="button" className={css.button_pencil} name="birthday" onClick={handleClick}>
        <HiPencil className={css.pencil}/></button></td>
      </>
      :
      <>
      ...
      className={css.input}
      ></input></td>
      <td><button type="button" className={css.button_pencil} name="birthday" onClick={clickSubmit}>
        <BsCheck className={css.check}/></button></td>
      </>
    }
    ...
    <tr>
      ...
      <td><button type="button" className={css.button_pencil} name="phone" onClick={handleClick}>
        <HiPencil className={css.pencil}/></button></td>
      </>
      :
      <>
      ...
      className={css.input}
      ></input></td>
      <td><button type="button" className={css.button_pencil} name="phone" onClick={clickSubmit}>
        <BsCheck className={css.check}/></button></td>
      </>
      }
    ...
    <tr>
      ...
      <td><button type="button" className={css.button_pencil} name="city" onClick={handleClick}>
        <HiPencil className={css.pencil}/></button></td>  
      </>
      :
      <>
      ...
      className={css.input}
      ></input></td>
      <td><button type="button" className={css.button_pencil} name="city" onClick={clickSubmit}>
        <BsCheck className={css.check}/></button></td>
      </>
      }
